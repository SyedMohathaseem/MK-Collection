...
const MKStore = {
    ...
    getDefaultOrders() {
        return [
            ...
            { id: 'MK-2026-003', customer: 'Sarah Johnson', email: 'user@mk.com', phone: '+1 555-5678', items: 2, itemDetails: [{ productId: 'prod-003', name: 'High-Waist Tailored Trousers', size: 'L', color: 'Navy', quantity: 2, price: 129 }], total: 258.00, status: 'processing', date: '2026-01-16', address: '789 Chic Blvd, Miami' },
